...
func (r *ProjectRepo) Create(ctx context.Context, project *models.Project) (err error) {
...
func (r *ProjectRepo) UpdateLikes(ctx context.Context, project *models.Project) error {
	tx, err := r.db.Begin(ctx)
	if err != nil {
		return err
	}
